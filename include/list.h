...
// src/lib/list.c: free all items in list from last to first
extern int list_free_all_reverse(list*point,runnable_t*datafree);
...
extern list*list_merge(list*l1,list*l2);
